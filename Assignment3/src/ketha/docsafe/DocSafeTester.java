...
public class DocSafeTester {
	...
	public static void test(){
		...
		//Encryptor en=new EncryptorDecryptor(5);
...
//		sto.saveDoc(doc8);
	...
	System.out.println("_________________");	
		...
		EncryptorDecryptor en4=new EncryptorDecryptor(5);
		DocStore sto4=new DocStore(en4);
		Document doc9=new Document(2,"Bhargavi");
		sto.saveDoc(doc1);
		sto.getDoc(5);
		sto.getDoc(2,5);
